...
import com.example.gamezop.ii.R;
import com.example.gamezop.ii.model.CardModel;
import com.example.gamezop.ii.model.Orientations;
...
public class CardContainer extends AdapterView<ListAdapter> {
    ...
    private void ensureFull() {
        while (mNextAdapterPosition < mListAdapter.getCount() && getChildCount() < mMaxVisible) {
            ...
            if(mOrientation == Orientations.Orientation.Ordered) {
    ...
    public void setOrientation(Orientations.Orientation orientation) {
        ...
        if(mOrientation != orientation) {
            ...
            if(orientation == Orientations.Orientation.Ordered) {
